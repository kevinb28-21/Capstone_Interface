...
The platform consists of two main APIs:
  Node.js API - Main backend API (Express.js)
  Python Flask API - Image processing service
...
See Node.js API Documentation for complete details.
...
See Flask API Documentation for complete details.
